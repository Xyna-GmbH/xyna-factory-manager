...
export class RestorableCapacitiesComponent extends RestorableRouteComponent<XoCapacityInformation> implements OnInit {
    ...
    constructor(
        ...
        this.i18nService.setTranslations(I18nService.DE_DE, capacities_translations_de_DE);
        this.i18nService.setTranslations(I18nService.EN_US, capacities_translations_en_US);
    }
