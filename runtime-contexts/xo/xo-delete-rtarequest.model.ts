...
@XoObjectClass(null, 'xmcp.factorymanager.rtcmanager', 'DeleteRTARequest')
export class XoDeleteRTARequest extends XoObject {
...
@XoArrayClass(XoDeleteRTARequest)
export class XoDeleteRTARequestArray extends XoArray<XoDeleteRTARequest> {
}
