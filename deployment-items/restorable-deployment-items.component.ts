...
export class RestorableDeploymentItemsComponent extends RestorableRouteComponent<XoDeploymentItem> implements OnInit {
    ...
    constructor(
        ...
        this.i18nService.setTranslations(I18nService.DE_DE, deployment_items_translations_de_DE);
        this.i18nService.setTranslations(I18nService.EN_US, deployment_items_translations_en_US);
    }
